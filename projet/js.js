        ...
        .then(projects => {
            ...
            projects.forEach(project => {
                ...
                projectCard.innerHTML = `
                    <img src="/image projet/${project.image}" alt="${project.title}" class="rounded-t-lg w-full h-64 object-cover">
                    <div class="p-4">
                        ...
                        <a href="${project.link}" class="inline-block px-8 py-4 mt-4 text-white bg-primary rounded-full shadow-lg text-lg font-semibold transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl">Voir plus</a>
                    </div>
                `;
